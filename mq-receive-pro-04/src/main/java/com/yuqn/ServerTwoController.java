...
public class ServerTwoController {
    public static void main(String[] args) {
        ...
        try {
            ...
            // 创建队列
            channel.queueDeclare("topicQueueTwo",true,false,false,null);
            // 声明交换机
             ...
             * */
            channel.queueBind("topicQueueTwo","topicExchange","aa.*");
            /*
             * 接收消息
             * 参数一：消费者需要监听的队列名
             * 参数二：拿到消息后是否自动移除消息
             ...
             * */
            channel.basicConsume("topicQueueTwo",true,"",new DefaultConsumer(channel){
                // 消息的具体接收和处理
                @Override
                public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                    String message = new String(body,"utf-8");
                    System.out.println("接收信息队列：topicQueueTwo - BindingKey：aa.*"+message);
                }
            });
